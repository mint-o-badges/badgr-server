...
# this method allows users that are authorized (but do not have to be admins)
# to register client credentials for their account,
# currently the user can only choose the name
