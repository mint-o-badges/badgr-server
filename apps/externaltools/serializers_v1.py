...
class ExternalToolSerializerV1(serializers.Serializer):
    ...
    def to_representation(self, instance):
        representation = super(ExternalToolSerializerV1, self).to_representation(
            instance
        )
...
class ExternalToolLaunchSerializerV1(serializers.Serializer):
    ...
    def to_representation(self, instance):
        representation = super(ExternalToolLaunchSerializerV1, self).to_representation(
            instance
        )
        requesting_user = (
        ...
        representation["launch_data"] = instance.generate_launch_data(
            user=requesting_user, context_id=context_id
        )
