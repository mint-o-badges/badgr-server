...
urlpatterns = [
    ...
    # legacy v1 endpoints
    url(r'^collections/(?P<slug>[-\w]+)/badges$', CollectionLocalBadgeInstanceList.as_view(),
        name='v1_api_collection_badges'),
    url(r'^collections/(?P<collection_slug>[-\w]+)/badges/(?P<slug>[^/]+)$',
    ...
    url(r'^collections/pdf/(?P<slug>[^/]+)$', pdf, name='generate-collection-pdf'),
