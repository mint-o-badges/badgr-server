...
class TestCollections(BadgrTestCase):
    ...
    def test_can_get_collection_detail(self):
        ...
        response = self.client.get(
            "/v2/backpack/collections/{}".format(self.collection.entity_id)
        )
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(
            response.data["result"][0]["shareHash"], self.collection.share_hash
        )
    ...
    def test_can_define_collection(self):
        ...
        self.assertEqual(
            [i["id"] for i in response.data.get("badges")],
            [
                self.local_badge_instance_1.entity_id,
    ...
    def test_can_delete_collection(self):
        ...
        """
        collection = BackpackCollection.objects.filter(
    ...
    def test_can_publish_unpublish_collection_serializer(self):
        ...
        serializer = CollectionSerializerV1(
            collection, data={"published": True}, partial=True
        )
        serializer.is_valid(raise_exception=True)
        serializer.save()
        ...
        serializer = CollectionSerializerV1(
            collection, data={"published": False}, partial=True
        )
        serializer.is_valid(raise_exception=True)
        serializer.save()
    ...
    def test_can_publish_unpublish_collection_api_share_method(self):
        ...
        """
        self.client.force_authenticate(user=self.user)
        response = self.client.get("/v1/earner/collections/fresh-badges/share")
        self.assertEqual(response.status_code, 200)
    ...
    def test_can_add_remove_collection_badges_via_serializer_v1(self):
        ...
        self.assertEqual(collection.cached_badgeinstances().count(), 2)
        self.assertEqual(
            [i.entity_id for i in collection.cached_badgeinstances()],
            [
                self.local_badge_instance_1.entity_id,
                self.local_badge_instance_2.entity_id,
            ],
    ...
    def test_can_add_remove_collection_badges_via_collection_detail_api(self):
        ...
        collection = BackpackCollection.objects.get(
            entity_id=response.data.get("slug")
        )  # reload
        self.assertEqual(collection.cached_badgeinstances().count(), 2)
        self.assertEqual(
            [i.entity_id for i in collection.cached_badgeinstances()],
    ...
    def test_can_add_remove_badges_via_collection_badge_detail_api(self):
        ...
        response = self.client.delete(
            "/v1/earner/collections/{}/badges/{}".format(
                collection.entity_id, data[0]["id"]
            ),
            data=data,
            format="json",
        )
    ...
    def test_can_add_remove_issuer_badges_via_api(self):
        ...
        self.assertEqual(
            [i.entity_id for i in self.collection.cached_badgeinstances()],
            [
                self.local_badge_instance_1.entity_id,
                self.local_badge_instance_2.entity_id,
            ],
        ...
        response = self.client.get(
            "/v1/earner/collections/{}/badges/{}".format(
                self.collection.entity_id, self.local_badge_instance_2.entity_id
            )
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_api_handles_null_description_and_adds_badge(self):
        ...
        data = {
            "badges": [
                {"id": self.local_badge_instance_1.entity_id, "description": None}
            ],
        ...
        self.client.force_authenticate(user=self.user)
        response = self.client.put(
            "/v1/earner/collections/{}".format(self.collection.entity_id),
            data=data,
            format="json",
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_can_add_remove_collection_badges_collection_badgelist_api(self):
        ...
        self.assertEqual(collection.cached_badgeinstances().count(), 2)
        self.assertEqual(
            [i.pk for i in collection.cached_badgeinstances()],
    ...
    def xit_test_can_update_badge_description_in_collection_via_detail_api(self):
        ...
        response = self.client.put(
            "/v1/earner/collections/{}/badges/{}".format(
                self.collection.entity_id, self.local_badge_instance_1.pk
            ),
            data={"id": 1, "description": "A cool badge."},
            format="json",
        )
        ...
        self.assertEqual(
            response.data,
            {"id": self.local_badge_instance_1.pk, "description": "A cool badge."},
        )

        obj = BackpackCollectionBadgeInstance.objects.get(
            collection=self.collection, instance_id=self.local_badge_instance_1.pk
        )
    ...
    def test_badge_share_json(self):
        ...
        response = self.client.get(
            ...
            **dict(HTTP_ACCEPT="application/json"),
        )

        self.assertEqual(response.status_code, 301)
        self.assertEqual(
            response.get("Location", None), self.local_badge_instance_1.public_url
        )
    ...
    def test_badge_share_html(self):
        ...
        """
        response = self.client.get(
            "/share/badge/{}".format(self.local_badge_instance_1.entity_id),
            **dict(
