    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="composition.LocalBadgeClass",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="composition.LocalBadgeInstance",
                    ),
                ),
            ],
            options={},
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                to="composition.LocalBadgeInstance",
                through="composition.LocalBadgeInstanceCollection",
            ),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="composition.CollectionPermission",
                to=settings.AUTH_USER_MODEL,
            ),
            preserve_default=True,
        ),
