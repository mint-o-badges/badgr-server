...
class IssuerStaffList(VersionedObjectMixin, APIView):
    ...
    def post(self, request, **kwargs):
        ...
        try:
            ...
            error_text = (
                "Wir haben die E-Mail-Adresse nicht im System gefunden.",
                "Es können nur Personen als Mitglied hinzugefügt werden, ",
                "die sich bereits einen Account auf OEB angelegt haben.",
            )
            if user_id is None:
                error_text = (
