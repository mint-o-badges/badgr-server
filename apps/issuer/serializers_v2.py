                    ...
                    [
                        ...
                        (
                            "type",
                            {
                                "type": "string",
                                "enum": [
                                    c[0] for c in BadgeInstance.RECIPIENT_TYPE_CHOICES
                                ],
                        ...
                        (
                            "plaintextIdentity",
                            {"type": "string", "description": "The plaintext identity"},
                        ),
                    ]
                ),
            },
                ...
                "properties": OrderedDict(
                    [
                        ...
                        (
                            ...
                            {
                                "type": "string",
                                "description": "Recipient interaction with Assertion. One of: Unaccepted, Accepted, or Rejected",  # noqa E501
                                "readOnly": True,
                            },
                        ),
                        (
