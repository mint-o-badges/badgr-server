...
def deserialize_badgeclass_json(apps, schema_editor):
    ...
    for badgeclass in BadgeClass.objects.all():
        ...
        local_criteria_url = OriginSetting.HTTP + reverse(
            "badgeclass_criteria", kwargs={"entity_id": badgeclass.slug}
        )
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            "BadgeInstance",
            "evidence_url",
            models.CharField(max_length=2083, blank=True, null=True, default=None),
        ),
