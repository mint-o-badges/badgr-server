...
from .base import (
    BadgrOAuth2TestsMixin,
    BadgrSocialAuthTestCase,
    DoesNotSendVerificationEmailMixin,
)


class LinkedInOAuth2ProviderTests(
    DoesNotSendVerificationEmailMixin, BadgrOAuth2TestsMixin, BadgrSocialAuthTestCase
):
